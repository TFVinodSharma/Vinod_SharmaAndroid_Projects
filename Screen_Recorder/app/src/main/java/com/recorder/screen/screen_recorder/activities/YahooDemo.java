...
public class YahooDemo extends Activity {

    Stack s ;
    WebView w1 = null;
    ByteArrayOutputStream mByteArrayOpStream = null;
    Bitmap bmpBuffer  = null;
    public static  String URL_ID1= "http://www.Yahoo.com";
    ...
    public void takepicture()
    {
        ...
        try{
            ...
            fos = new FileOutputStream( "/sdcard/YTest/" +"Yahoo"+
