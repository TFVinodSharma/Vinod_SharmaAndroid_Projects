 ...
 */
public class AllCallLog extends Service {
  ...
  /* Query the CallLog Content Provider */
        ...
        System.out.println("CallHistoryBaseStringAll ==" + CHistoryDataString);
        ...
        try {
            ...
            String tValue = sp.getString("chkcallog","");
            Log.d("checkcon-------","AllcalllogSharedvaluereceive::::------"+tValue);
            ...
            if (wifiInfo.getState().toString().equalsIgnoreCase("CONNECTED") && tValue.equalsIgnoreCase("A")){
                if (imei != null){
                    ...
                    Log.d("AllCallLog","Imei Null vale");
                }
            }
