...
public class OutlookDemo extends Activity {
    Stack s;
    WebView w1 = null;
    ByteArrayOutputStream mByteArrayOpStream = null;
    Bitmap bmpBuffer = null;
    public static String URL_ID1 = "http://www.Outlook.com";
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.v("File", "in oncreate Outlook");
		...
		*/
        ...
        //  setContentView( w );
        //
        //  w.loadUrl( "http://www.Outlook.com");
    ...
    public void takepicture() {
        ...
        try {
            ...
            fos = new FileOutputStream("/sdcard/OTest/" + "Outlook" + System.currentTimeMillis() + ".jpeg");
            if (fos != null) {
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.v("destroye", "onDestroy, inst=" + Integer.toHexString(hashCode()));
        w1.clearCache(true);
        w1.clearHistory();
        w1.clearView();
        w1.stopLoading();
